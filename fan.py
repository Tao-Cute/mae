...
# from .cait import Class_Attention as ClassAttn
...
class FAN(Backbone):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 act_layer=None, norm_layer=None, cls_attn_layers=2, use_pos_embed=True, eta=1., tokens_norm=False, pretrained=None, out_index=-1, use_checkpoint=False, out_channel=[], out_ids = [0, 1, 2, 3], init_cfg=None):
